...
var update = function(req, res)
{
	...
	tracing.create('ENTER', 'PUT blockchain/assets1/assets/asset/'+assetID+'/owner', req.body);
	...
	tracing.create('INFO', 'PUT blockchain/assets1/assets/asset/'+assetID+'/owner', 'Formatting request');
	...
	tracing.create('INFO', 'PUT blockchain/assets1/assets/asset/'+assetID+'/owner', 'Updating owner value');
	...
	request(options, function(error, response, body)
	{
		...
		if (!error && !body.hasOwnProperty("error") && response.statusCode == 200) // if it appears to work run a query to check if the new owner can see the car
		{
			...
			var url = configFile.config.app_url +'/blockchain/assets1/assets/'+assetID+'/owner';
			...
			tracing.create('INFO', 'PUT blockchain/assets1/assets/asset/'+assetID+'/owner', 'Achieving Consensus');
			...
			var interval = setInterval(function(){
				if(counter < 15){
					request(options, function (error, response, body) {
						...
						if (!error && response.statusCode == 200)
						{
							...
							tracing.create('EXIT', 'PUT blockchain/assets1/assets/asset/'+assetID+'/owner', result);
				...
				{					
					...
					tracing.create('ERROR', 'PUT blockchain/assets1/assets/asset/'+assetID+'/owner', error)
